...
urlpatterns = [
    ...
    path('cards/run-bulk-update/', views.admin_run_bulk_update, name='admin_run_bulk_update'),
    ...
    path('run-generate-blog/', views.admin_generate_blog, name='admin_generate_blog'),
]
